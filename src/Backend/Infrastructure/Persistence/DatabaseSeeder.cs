...
public static class DatabaseSeeder
{
        ...
        CancellationToken cancellationToken)
    {
        var definitions = new[]
        {
            ...
            (Code: "CATALOG_ACCESS",              Name: "Danh mục đào tạo",                  Description: "Truy cập module danh mục đào tạo",                     Category: "Danh mục đào tạo"),
        ...
        CancellationToken cancellationToken)
    {
        var definitions = new[]
        {
            ...
            (RoleCode: "ADMIN", PermissionCode: "CATALOG_ACCESS"),
            ...
            (RoleCode: "SURVEY_ADMIN", PermissionCode: "CATALOG_ACCESS"),
